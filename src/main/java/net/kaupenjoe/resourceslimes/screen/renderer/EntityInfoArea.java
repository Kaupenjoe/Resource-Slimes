...
public class EntityInfoArea extends InfoArea implements IDrawable {
    private final ResourceSlimeEntity entity;

    public EntityInfoArea(int xMin, int yMin, ResourceSlimeEntity entity, int width, int height)  {
    ...
    public List<Component> getTooltips() {
        return List.of(new TextComponent(entity.getResourceItem().getDescriptionId()));
    }
