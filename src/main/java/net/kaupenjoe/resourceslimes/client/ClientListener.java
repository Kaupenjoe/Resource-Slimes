...
import net.kaupenjoe.resourceslimes.screen.SlimeIncubationStationScreen;
...
public class ClientListener {
	...
	public static void clientSetup(final FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			...
			MenuScreens.register(ModMenuTypes.SLIME_EXTRACT_CLEANING_STATION_MENU.get(),
					SlimeExtractCleaningStationScreen::new);
	...
	public static void registerParticleFactories(final RegisterParticleProvidersEvent event) {
		event.register(ModParticles.ENERGY_PARTICLES.get(), EnergyParticle.Provider::new);
	}
	...
	private static void setFluidRenderLayer() {
		...
		ItemBlockRenderTypes.setRenderLayer(ModBlocks.PINK_SLIME_PEARL_SLIME_FLUID_BLOCK.get(),
				RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer(ModFluids.PINK_SLIME_PEARL_SLIME_FLUID.get(), RenderType.translucent());
		ItemBlockRenderTypes.setRenderLayer(ModFluids.PINK_SLIME_PEARL_SLIME_FLUID_FLOWING.get(),
				RenderType.translucent());
