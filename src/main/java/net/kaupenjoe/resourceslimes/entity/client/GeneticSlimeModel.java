...
import net.kaupenjoe.resourceslimes.entity.GeneticSlime;
...
public class GeneticSlimeModel<T extends GeneticSlime> extends SlimeModel<T> {
    public GeneticSlimeModel(ModelPart pRoot) {
        super(pRoot);
    }
