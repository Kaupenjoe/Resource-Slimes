...
public class SlimeExtractCleaningRecipeBuilder implements RecipeBuilder {
    private final Item result;
    private final Ingredient ingredient;
    private final int count;
    private final Advancement.Builder advancement = Advancement.Builder.advancement();

    public SlimeExtractCleaningRecipeBuilder(ItemLike ingredient, ItemLike result, int count) {
    ...
    public static class Result implements FinishedRecipe {
        ...
        public RecipeSerializer<?> getType() {
            return SlimeExtractCleaningStationRecipe.Serializer.INSTANCE;
        }
