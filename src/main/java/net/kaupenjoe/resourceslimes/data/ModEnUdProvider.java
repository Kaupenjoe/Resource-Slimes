...
public class ModEnUdProvider implements DataProvider {
    private static final Gson GSON = (new GsonBuilder()).setPrettyPrinting().disableHtmlEscaping().create();
    private final DataGenerator generator;
    private final Map<String, String> data = new HashMap<>();

    public ModEnUdProvider(DataGenerator gen) {
        this.generator = gen;
    }

    protected void addTranslations() {
        // noinspection ConstantConditions
        try (final var is = new InputStreamReader(ResourceSlimes.class.getResourceAsStream("/assets/resourceslimes/lang/en_us.json"))) {
            ...
            ResourceSlimes.LOGGER.warn("Failed to generate en_ud translations: ", e);
        }
    }
    ...
    public void run(@NotNull CachedOutput cache) throws IOException {
        ...
        saveStable(cache, data, generator.getOutputFolder().resolve("assets/" + ResourceSlimes.MOD_ID + "/lang/en_ud.json"));
    }
